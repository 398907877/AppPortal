...
public class GetErine extends TagSupport {
	...
	public int doEndTag() throws JspTagException {
		try {
			...
			ErnieService TService = (ErnieService) ctx.getBean("ernieService");
			Ernie tenancy =  TService.findById(Long.parseLong(id));
			if(tenancy!=null){
			pageContext.getOut().write(tenancy.getTitle());
			}else{
