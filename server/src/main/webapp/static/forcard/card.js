...
Card = (function() {
  ...
  Card.prototype.defaults = {
    ...
    formSelectors: {
      ...
      turnButton: 'button[name="turnbutton"]',
    },
    cardSelectors: {
  ...
  Card.prototype.attachHandlers = function() {
    ...
    this.$turnButton.on('click', this.handle('flipCard')).on('', this.handle('flipCard'));
    
    
    this.$cvcInput.bindVal(this.$cvcDisplay, validToggler('validateCardCVC')).on('click', this.handle('flipCard')).on('', this.handle('flipCard'));
