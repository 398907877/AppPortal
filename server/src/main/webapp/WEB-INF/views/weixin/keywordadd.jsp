...
<div id="text" style="display: none; ">
	...
	<div class="row">
		...
		<div class="col-md-10 ">
			<div class="jumbotron">
				<h3 style="display: inline-block; color: #3276b1;">新建关键字</h3>
				...
				<form:form role="form" method="post" modelAttribute="rule"
					action="${ctx}/mgr/weixin/wordadd"  id="sub">
					
				
					 
					<div class="form-group">
						<label for="title">关键字名称<h6>支持同时新增多个关键字用<kbd>逗号 ,</kbd>分隔</h6></label> <input type="text"
							class="form-control" id="title" name="keywordname" value="">
					</div>  
					<div class="form-group">
