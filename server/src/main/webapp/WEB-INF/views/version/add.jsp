...
<body>
	...
	<form id="inputForm" method="post" Class="form-horizontal" action="${ctx}/mgr/apps/version/save" enctype="multipart/form-data"  >
...
<div class="form-group">
	...
	<div class="col-sm-10 controls">
						...
						<option value="ANDROID-NHD" >新华都android版</option>
						<option value="IOS-NHD_FREE"  >新华都iPhone越狱版</option>
						<option value="IOS-NHD_ITUNES">新华都iPhone正式版</option>
						</select>
				</div>
			</div>
						<div class="form-group">
	...
	<div class="col-sm-10 controls">
					...
					<textarea rows="3" style="width:250px" name="intro"  class="input-large" value="${versionInfo.intro }"></textarea>
				</div>
			</div>
