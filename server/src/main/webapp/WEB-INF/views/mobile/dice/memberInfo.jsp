...
<title>恭喜你中奖啦！</title>
<style type="text/css" >
	body {font-family: '微软雅黑','黑体','宋体', Verdana, sans-serif;}
...
<body >
	...
	<br>
	 <form:form modelAttribute="tenancyUser" method="post" id="form" enctype="multipart/form-data" cssClass="form-horizontal"  action="${ctx}/m/ernies/bobing/memberInfoSave">
