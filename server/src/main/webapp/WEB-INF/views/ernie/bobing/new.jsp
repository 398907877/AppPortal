...
<body>
	<div class="row">
		...
		<div class="col-md-10 ">
			...
			<form:form id="form"   role="form" method="post" modelAttribute="ernie" action="${ctx}/mgr/ernies/bobing/create"  enctype="multipart/form-data">
		       <input type="hidden" name="uid" value="${currentTenancyID }" />
