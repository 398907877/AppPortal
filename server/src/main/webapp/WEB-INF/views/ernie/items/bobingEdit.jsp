...
<body>
	<div class="row">
		...
		<div class="col-md-10 ">
			...
			<form:form id="from" role="form" method="post" modelAttribute="ernieItem" action="${ctx}/mgr/ernieItems/bobing/update" enctype="multipart/form-data">
				<jsp:include page="bobingForm.jsp" />
			</form:form>
		</div>
	</div>
</html>