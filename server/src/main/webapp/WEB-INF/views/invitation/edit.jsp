...
<div class="row">
	...
	<form:form id="form" method="post" modelAttribute="invitation" cssClass="form-horizontal" action="${ctx}/mgr/invitation/update"  enctype="multipart/form-data">
		<form:hidden path="id" />
	...
	function deleteoldpic(id){
		if(confirm("确定要删除吗?")){ 
           $.ajax({
	         url: "${ctx}/mgr/invitation/"+id+"/delpic",
	         type: 'DELETE',
	         async:false,
