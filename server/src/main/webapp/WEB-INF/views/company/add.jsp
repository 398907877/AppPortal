...
<body>
	...
	<form:form id="form" method="post" modelAttribute="company" cssClass="form-horizontal" action="${ctx}/mgr/company/save"  enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<a href="<%=request.getContextPath()%>/mgr/crm/index" class="btn  btn-default">返回</a>
			</div>
		</div>
	</form:form>
