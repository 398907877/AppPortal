 ...
 *******************************************************************************/
package com.huake.saas.service.account;
 ...
 * @author calvin
 */
public class AccountServiceTest extends BaseTransactionalTestCase{

	@InjectMocks
	private AccountService accountService;
	@Autowired
	private TcustomerService tService;
	@Mock
...
//	}
	...
	public void testFindCustomer(){
		System.out.println(tService.findTcustomerByType(new Long(0), new Long("20140417122551"), 0));
	}
}
